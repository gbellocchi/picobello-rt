...
reg   [7:0] wide_buffer_V_addr_reg_114;
reg   [7:0] wide_buffer_V_addr_reg_114_pp0_iter1_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        wide_buffer_V_addr_reg_114_pp0_iter1_reg <= wide_buffer_V_addr_reg_114;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln1027_fu_71_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        wide_buffer_V_addr_reg_114 <= i_4_cast_fu_83_p1;
    end
end
...
assign add_ln840_fu_93_p2 = (wide_buffer_V_q1 + conv_i_i21_cast_reg_105);
...
assign wide_buffer_V_address0 = wide_buffer_V_addr_reg_114_pp0_iter1_reg;

assign wide_buffer_V_address1 = i_4_cast_fu_83_p1;

assign wide_buffer_V_d0 = add_ln840_reg_120;
