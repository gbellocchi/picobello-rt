...
reg   [127:0] wide_buffer_V_load_reg_142;
wire   [63:0] loop_index_i41_cast8_fu_93_p1;
wire    ap_block_pp0_stage0_01001;
reg   [7:0] loop_index_i41_fu_50;
wire   [7:0] p_cast4_fu_98_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((exitcond_fu_104_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            loop_index_i41_fu_50 <= p_cast4_fu_98_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            loop_index_i41_fu_50 <= 8'd0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        wide_buffer_V_load_reg_142 <= wide_buffer_V_q0;
    end
end

always @ (*) begin
    if (((exitcond_fu_104_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ...
        ap_sig_allocacmp_loop_index_i41_load = loop_index_i41_fu_50;
    end
end
...
assign exitcond_fu_104_p2 = ((ap_sig_allocacmp_loop_index_i41_load == 8'd255) ? 1'b1 : 1'b0);

assign loop_index_i41_cast8_fu_93_p1 = ap_sig_allocacmp_loop_index_i41_load;
...
assign m_axi_wide_port_WDATA = wide_buffer_V_load_reg_142;

assign m_axi_wide_port_WID = 1'd0;

assign m_axi_wide_port_WLAST = 1'b0;

assign m_axi_wide_port_WSTRB = 16'd65535;

assign m_axi_wide_port_WUSER = 1'd0;

assign p_cast4_fu_98_p2 = (ap_sig_allocacmp_loop_index_i41_load + 8'd1);

assign wide_buffer_V_address0 = loop_index_i41_cast8_fu_93_p1;
